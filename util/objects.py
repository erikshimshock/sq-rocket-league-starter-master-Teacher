...
# investigating ... but seems like bug in QuickChats object not populating
# (? module no longer working after RLBot was ported to python 3.11?)
# OR /Virx (Stallion)/  suggested that it may actually work as intended at runtime
#      ... but won't (look like) resolve in an IDE
from rlbot.utils.structures.quick_chats import QuickChats

import sys # for sys.max
...
class GoslingAgent(BaseAgent):
    ...
    def initialize_agent(self):
        ...
        # # from QuickChat realistic example:
        # # https://github.com/RLBot/RLBotPythonExample/wiki/Quickchat
    ...
    def get_output(self, packet):
        ...
        # # from QuickChat realistic example:
        # # https://github.com/RLBot/RLBotPythonExample/wiki/Quickchat
        # current_score = self.get_game_score(packet)
    ...
    # # from QuickChat realistic example:
    # # https://github.com/RLBot/RLBotPythonExample/wiki/Quickchat
    # def get_game_score(self, packet):
    ...
    def get_closest_large_boost(self):
         # Boosts (focusing only on large boosts that are currently active)
        available_boosts = [boost for boost in self.boosts if boost.active and boost.large]

        closest_boost = None
        closest_distance = sys.maxsize    # too big, so that any real distance will be shorter/better
    ...
    # TODO ? video version uses full magnitudes ... maybe switch to just using y values?
    def is_in_front_of_ball(self):
        ...
        # TODO 1000 is from video ... maybe too high? should be negative?
        return me_to_foe_goal < ball_to_foe_goal + 1000
